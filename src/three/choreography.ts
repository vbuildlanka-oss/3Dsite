...
export const SHOTS: CameraKey[] = [
  { tl: 0.0, pos: [0, 0.92, 6.1], look: [0, 0.54, 0], fov: 30 },
  { tl: 0.55, pos: [0.95, 1.25, 5.8], look: [0, 0.54, 0], fov: 30, roll: -0.01 },
  ...
  { tl: 3.16, pos: [0, 2.45, 4.7], look: [0, 0.72, 0], fov: 34 },
  { tl: 3.66, pos: [0, 1.5, 4.5], look: [0, 0.6, 0], fov: 30 },
